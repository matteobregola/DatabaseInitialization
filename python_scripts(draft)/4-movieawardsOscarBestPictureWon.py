                    ...
                    if line_count == 1:
                        ...
                        for i in indexes:
                            if(column==0):
                                ...
                                txt_file.write("'Oscar, best picture','won'::\"awardresult\"")
...
ExtractWrite(queryfile="4-movieawardsOscarBestPictureWON.txt",tablename="movieawards",filename="bestpicture.csv",indexes=[5,7])
