                    ...
                    if line_count == 1:
                        ...
                        for i in indexes:
                            if(column==0):
                                ...
                                txt_file.write("'Oscar, best picture','nominated'::\"awardresult\"")
...
ExtractWrite(queryfile="4-movieawardsOscarBestPictureNOMINATED.txt",tablename="movieawards",filename="bestpicturenominees.CSV",indexes=[5,7])
