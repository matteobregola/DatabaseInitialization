                    ...
                    if line_count == 1:
                        ...
                        for i in indexes:
                            if(column==0):
                                ...
                                txt_file.write("'Oscar, best cinematography','won'::\"awardresult\"")
...
ExtractWrite(queryfile="4-movieawardsOscarBestCinematographyWON.txt",tablename="movieawards",filename="bestcinematographyWon.csv",indexes=[5,7])
